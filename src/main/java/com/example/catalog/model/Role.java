...
import static com.example.catalog.model.Permission.*;
...
public enum Role {
    ...
    ADMIN(Set.of(ADMIN_READ, ADMIN_UPDATE, ADMIN_DELETE, ADMIN_CREATE, MANAGER_READ, MANAGER_UPDATE, MANAGER_DELETE,
                 MANAGER_CREATE, USER_READ, USER_CREATE, USER_UPDATE, USER_DELETE)),
