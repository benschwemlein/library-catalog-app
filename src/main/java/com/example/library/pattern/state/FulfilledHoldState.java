...
@Component
public class FulfilledHoldState implements HoldState {

    private static final String TERMINAL_MESSAGE = "Hold is already fulfilled - terminal state";
    ...
    @Override public HoldStatus getStatus() { return HoldStatus.FULFILLED; }
}
