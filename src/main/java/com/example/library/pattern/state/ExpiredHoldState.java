...
@Component
public class ExpiredHoldState implements HoldState {

    private static final String TERMINAL_MESSAGE = "Hold is already expired - terminal state";
    ...
    @Override public HoldStatus getStatus() { return HoldStatus.EXPIRED; }
}
